	...
	if(isWecomeMsg) {		
		...
		setTimeout(function() {
			var msg = {
				from: agentId,
				name: agentNick,
				msg:"Welcome to Robi Live Chat Service. How can I help you? ",
		...
		$.ajax({
			...
			success:function(resp) {
				...
				if(chat_accept==false){
					...
					body_html += "</div>";
					body_html += "<div id='chat_queue_msg' class='col-md-12'>Dear Customer, all our service executives are busy at this moment "+
									"but will be available shortly to get back to you. Meanwhile you can contact us through email at 123@robi.com.bd "+
									"or through SMS at 8123...</div>";

					// body_html += "<div class='col-md-6'>";
					// body_html += "<img class='img-thumbnail' src='"+baseUrl+"ccd/images/android.svg' alt='preloader'>";
					// body_html += "</div>";
					// body_html += "<div class='col-md-6'>";
					// body_html += "</div>";

					body_html += "<div id='queue_body_preloader' class='chat-preloader text-center' style='height:50%;margin-top:50px' >";
					body_html += "<label><small>Please wait...<small></label>";
