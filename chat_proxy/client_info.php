...
$service = do_cc_request("user=$dbprefix&method=getServices&src=$page_id");
...
$num_agents = 0;
$ws_port = 0;
$lang = do_cc_request("user=$dbprefix&method=getLanguages&src=$page_id");
$response->language = substr($lang, 0, 3) == "200" ? substr($lang, 4) : "";


//if ($db->cctype > 0) {
if (1) {
  $ws_ep = do_cc_request("user=$dbprefix&method=getWsEndPoint");
        /*
...
$result = do_cc_request("user=$dbprefix&method=getNumChatAgents");
// var_dump($result);
