...
<div class="container-fluid" id="dashboard">
  <div class="header-summary row">
        ...
        <div class="col-xs-8 col-sm-9 col-md-9 col-lg-9"><h3 class="text-center text-info">Dashboard 777</h3></div>
...
<script>
    ...
    var agents_of_777_category = <?php echo !empty($agents_of_777_category) ? json_encode($agents_of_777_category) : json_encode(array()); ?>;
...
<script>
    ...
    var app = new Vue({
        ...
        data : {
            ...
            agents : _.keyBy(agents_of_777_category,'agent_id'),
