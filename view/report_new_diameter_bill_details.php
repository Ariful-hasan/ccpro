...
$grid->AddModelNonSearchable("Bill Time", "dm_bill_time", 100, "center");
$grid->AddModelNonSearchable("Call ID", "callid", 100, "center");
$grid->AddModelNonSearchable("CLI", "cli", 100, "center");
$grid->AddModelNonSearchable("IVR Time", "time_in_ivr", 100, "center");
$grid->AddModelNonSearchable("Wait Time", "hold_in_q", 100, "center");
$grid->AddModelNonSearchable("Agent Time", "service_time", 100, "center");
