...
$grid->AddModel("Date&Time", "sdate", 125, "center", ".date", "Y-m-d H:i:s", "Y-m-d H:i:s", true, "datetime");
$grid->SetDefaultValue("sdate", date($report_date_format." 00:00"), date($report_date_format." 23:59", strtotime('+1day')));
...
$grid->AddSearhProperty("Wrap Up", "disposition_id",'select',['*'=>'All']+$disposition_list);
...
// $grid->AddModelNonSearchable('callid', "callid", 75,"center");
...
$grid->AddModelNonSearchable('Transfer Tag', "transfer_tag", 110,"center");
