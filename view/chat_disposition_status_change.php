<div class="col-md-6 col-sm-6 col-lg-6">
    <form action="<?php echo $this->url("task=chatdc&act=change-status&did={$request->getRequest('did')}&skill_id={$request->getRequest('skill_id')}"); ?>" method="post" class="disposition-partition-change">
