...
$( document ).ready( function() {
    ...
    Initialize_Summer_note('textarea#mail_body', ['table','view','insert'],"<?php //echo $this->url('task=emailsignature&act=uploadSignatureImage&sid='.$sid); ?>", "<?php //echo $this->url('task=emailsignature&act=DeleteSignatureImage'); ?>");
...
<tbody>
	...
	<tr class="form_row">
		...
		<td>
			<textarea name="mail_body" id="mail_body" style="width:600px;height:200px;"><?php echo !empty($service->mail_body)?nl2br(base64_decode($service->mail_body)):"";?></textarea>
		</td>
	</tr>
	<tr class="form_row_alt">
