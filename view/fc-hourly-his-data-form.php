...
<div class="col-md-12 col-sm-12">
    <div class="row">
        <form name="frm_add_his_data" method="post" action="<?php echo $this->url('task=forecast-settings&act=add-his-data');?>" enctype="multipart/form-data">
            <div class="col-md-12 col-sm-12 col-lg-12">
                <div class="form-group form-group-sm">
                    <label for="forcast_his_data" class="control-label"> Upload File </label>
                    <input id="forcast_his_data" name="forcast_his_data" type="file" required />
                </div>
