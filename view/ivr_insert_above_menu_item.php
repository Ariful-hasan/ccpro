...
<tbody>
	...
	<tr class="form_row">
		<td class="form_column_caption" width="33%"><span class="required">*</span> Target node:</td>
		<td>
	...
	<tr class="form_row">
		<td colspan="2" class="form_column_submit">
			<input class="form_submit_button" type="submit" value=" Insert  " name="insertnode" /> <br><br>
		</td>
	</tr>
</tbody>
</table>
