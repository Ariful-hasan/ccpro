...
<?php 
    ...
    $grid->AddModelNonSearchable('Update time', "served_time", 120,"center");
    $grid->AddModel('Agent ID', "agent_id", 80, "center");
    $grid->AddModelNonSearchable('Nick name', "nick", 100,"center");
...
function playVMB(cid, ts)
{
	...
	audioSrc.src = audioSrcBase + '&cid='+cid+'&ts='+ts+'&ct='+Date.now();
        audioPlayer.load();
        audioPlayer.play();
