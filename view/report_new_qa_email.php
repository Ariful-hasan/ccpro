...
$grid->AddModelCustomSearchable('Evaluation Date', "sdate", 120, "center","report-datetime");
...
$grid->AddModelNonSearchable('Contact <br /> Date&Time', "create_time", 120,"center");
//$grid->AddModelNonSearchable('Evaluation <br /> Date', "evaluation_time", 120,"center");
$grid->AddModelNonSearchable('Customer <br /> ID', "customer_id", 150,"center");
$grid->AddModelNonSearchable('Email', "email", 150,"center");
