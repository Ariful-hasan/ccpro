...
$grid->AddModelCustomSearchable('Date Time', "date_time", 110, "center","report-datetime");
$grid->SetDefaultValue("date_time", date($report_date_format." 00:00"), date($report_date_format." 00:00", strtotime('+1day')));
