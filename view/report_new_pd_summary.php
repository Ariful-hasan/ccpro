...
$grid->AddModelNonSearchable('Agent Name', "agent_name", 75, "center");
$grid->AddModelNonSearchable('Total Dial Call', "total_dial", 100, "center");
$grid->AddModelNonSearchable('Successful call count', "total_answered", 100, "center");
$grid->AddModelNonSearchable('Unsuccessful call count', "total_failed", 100, "center");
$grid->AddModelNonSearchable('Talk Time (Sec)', "total_talk", 100, "center");
$grid->AddModelNonSearchable('Ring Time (Sec)', "total_ring", 100, "center");
