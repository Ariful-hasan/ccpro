...
$grid->AddModelNonSearchable('Total staffed time <br>(h:m:s)', "staffed_time", 100,"center");
$grid->AddModelNonSearchable('Total handling time <br>(h:m:s)', "handling_time", 100,"center");
$grid->AddModelNonSearchable('Total missed time <br>(h:m:s)', "missed_call_time", 100,"center");
$grid->AddModelNonSearchable('Total ACW time <br>(h:m:s)', "acw_time", 100,"center");
$grid->AddModelNonSearchable('Total AUX time <br>(h:m:s)', "pause_time", 100,"center");
