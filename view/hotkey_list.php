<?php
	...
	$grid->AddModelNonSearchable("Propertry", "action", 80,"center");
	$grid->AddModelNonSearchable("Hotkey", "hot_key", 80,"center");
	$grid->AddModelNonSearchable("Status", "status", 80,"center");	
	$grid->AddModelNonSearchable("Action", "action2", 80,"center");	
