...
$(document).ready(function(){
	$("#newMyTicket").click(function(){
		window.location = "<?php echo $this->url("task=crmticket&type=myjob&status=O&newall=Y");?>";
	});
	$("#penMyTicket").click(function(){
		window.location = "<?php echo $this->url("task=crmticket&type=myjob&status=P&newall=Y");?>";
	});
	$("#cliMyTicket").click(function(){
		window.location = "<?php echo $this->url("task=crmticket&type=myjob&status=C&newall=Y");?>";
	});
	
	$("#todayNewTicket").click(function(){
		window.location = "<?php echo $this->url("task=crmticket&status=O&tfield=update&newall=24&sdate=$startDate&edate=$endDate");?>";
	});
	$("#todayPenTicket").click(function(){
		window.location = "<?php echo $this->url("task=crmticket&status=P&tfield=update&newall=24&sdate=$startDate&edate=$endDate");?>";
	});
	$("#todayCliTicket").click(function(){
		window.location = "<?php echo $this->url("task=crmticket&status=C&tfield=update&newall=24&sdate=$startDate&edate=$endDate");?>";
	});
	$("#todaySerTicket").click(function(){
		window.location = "<?php echo $this->url("task=crmticket&status=S&tfield=update&newall=24&sdate=$startDate&edate=$endDate");?>";
	});

	$("#allNewTicket").click(function(){
		window.location = "<?php echo $this->url("task=crmticket&status=O&newall=Y");?>";
	});
	$("#allPenTicket").click(function(){
		window.location = "<?php echo $this->url("task=crmticket&status=P&newall=Y");?>";
	});
	$("#allCliTicket").click(function(){
		window.location = "<?php echo $this->url("task=crmticket&status=C&newall=Y");?>";
	});
});
</script>
