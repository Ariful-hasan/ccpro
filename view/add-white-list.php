...
<div class="col-md-12 col-sm-12">
    <div class="row">
        <form name="frm_add_white_list" method="post" action="<?php echo $this->url('task=black-white&act=add-white-list');?>" enctype="multipart/form-data">
            ...
            <div class="col-md-12 col-sm-12 col-lg-12">
                ...
                <input id="white_list" name="white_list" type="file" required/>
