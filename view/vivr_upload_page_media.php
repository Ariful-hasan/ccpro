...
<form method="post"
      action="<?php echo $this->url('task=vivr-panel&act=upload-page-media-file&vivrid=' . $vivr_id . '&page_id=' . $page_id); ?>"
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                if ($audio_file_bn != '') {
                    ...
                    echo " <a href=". $this->url('task=vivr-panel&act=delete-vivr-file&language=BN&page_id=' . $page_id). " attr-lang-title='$audio_file_bn' oncompleted='DeleteResponse' msg='Are you sure to delete?' class='ConfirmAjaxWR btn btn-xs btn-danger delete-url' > <i class='fa fa-times'></i> </a> ";
                }
                ?>
            ...
            if ($audio_file_en != '') {
                ...
                echo "<a href=". $this->url('task=vivr-panel&act=delete-vivr-file&language=EN&page_id=' . $page_id). "  attr-lang-title='$audio_file_en' oncompleted='DeleteResponse' msg='Are you sure to delete?' class='ConfirmAjaxWR btn btn-xs btn-danger delete-url' > <i class='fa fa-times'></i> </a>";
            }
            ?>
    ...
    <div style="padding: 10px">
        <button type="submit" class="btn btn-success" name="submit_file"> Upload </button>
    </div>
