...
$grid->AddModel("Date", "sdate", 125, "center", ".date", "Y-m-d H:i:s", "Y-m-d H:i:s", true, "datetime");
...
//$grid->AddModelNonSearchable("FCR Calls", "fcr_call", 100, "center");
//$grid->AddModelNonSearchable("FCR %", "fcr_percent", 100, "center");
