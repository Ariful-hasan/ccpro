...
//$grid->AddSearhProperty('Score Comparison:', 'score_comparison', 'select', ['*' => 'All']+$comparison_types );
...
$grid->AddModelNonSearchable('Customer <br /> Name', "customer_name", 150,"center");
$grid->AddModelNonSearchable('MSISDN', "msisdn", 150,"center");
$grid->AddModelNonSearchable('Wrap-up <br /> Code', "wrap_up_code", 100,"center");
//$grid->AddModelNonSearchable('ICE', "ice", 100,"center");
