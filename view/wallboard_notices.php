<?php
	...
	$grid->url =  $this->url('task=get-tools-data&act=WallBoardNotice');
	...
	$grid->AddModelNonSearchable("Notice", "notice", 80,"center");
	$grid->AddModelNonSearchable("Status", "active", 80,"center");
	$grid->AddModelNonSearchable("Image", "image", 80,"center");
