...
if(!function_exists('generic_date_format_from_report_datetime')){
    function generic_date_format_from_report_datetime($value, $format = REPORT_DATE_FORMAT, $return_format = 'Y-m-d'){
        return date_format(date_create_from_format($format . " H:i", $value), $return_format);
    }
}
...
if (!function_exists('ev_access_list')) {
    ...
    {
        $access_list = array(
            'IB' => 'Inbound Report', // inbound list view permission
            'PD' => 'PD Report', // PD list view permission
            'OB' => 'Outbound Report', // outbound list view permission
            'DL' => 'Download',
            'PV' => 'Play Voice',
            'PS' => 'Play Screen Log',
            'FV' => 'Form View',
            'FC' => 'Form Ceate',
            'VE' => 'View Evaluate', // evaluation form view permission
            'CE' => 'Ceate Evaluate', // evaluation form create permission
            'CB' => 'Chat Bot',
            'WC' => 'Web Chat Report', // web chat list view permission
            'VC' => 'View Chat', // chat log view permission
            'EV' => 'Email Report', // email report list view permission
            'SR' => 'SMS Report', // sms report list view permission
            'SL' => 'View SMS Log', // sms log view permission
            'ES' => 'Voice Emotion Search' // voice emotion search permission
        );
    ...
    function get_report_config_list()
    {
        $report_config_list = [
            "1563780159" => [
                ...
                'get-report-new-data_report-auto-sms' => [
                    "days" => 1,
                    "hide_col" => []
                ],
                'get-report-new-data_agent-webchat-performance-summary' => [
                    "days" => 1,
                    "hide_col" => []
                ]
            ],
            ...
            "1530771846" => [
                ...
                'get-report-new-data_report-btrc-summary' => [
                    "days" => 31,
                    "hide_col" => []
                ],
                'get-report-new-data_report-evaluator-summary' => [
                    "days" => 31,
                    "hide_col" => []
                ],
                'get-report-new-data_report-chat-co-browse-details' => [
                    "days" => 1,
                    "hide_col" => []
                ]
            ],
...
if (!function_exists('log_text')) {
    function log_text($log_data, $folder_path="temp/webchat_log/", $delete_time=31){
        ...
        if($deleteCall == rand(0,9)){
            ...
            $monthBeforeDate = date("Y_m_d", strtotime("-$delete_time days"));
...
if (!function_exists('get_share_key')) {
    function get_share_key()
    {
        return "b56dd15bdf845cf360a141326cc2e92a";
    }
}

if (!function_exists('get_click_to_call_url')) {
    function get_click_to_call_url($request_string)
    {
        return "http://192.168.10.64/click2call?param={$request_string}";
    }
}
