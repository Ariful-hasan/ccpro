...
$skill_id = "";
$result = do_cc_request("user=aa&method=getServiceSkillId&srv=$service&page_id=$page_id");
if (substr($result, 0, 3) == "200") {
    ...
    /*
        ...
        */
        ...
        if (!empty($skill_id)) {
            $result = do_cc_request("user=aa&method=getNumChatAgents&skill_id=$skill_id");
            if (substr($result, 0, 3) == "200") {
